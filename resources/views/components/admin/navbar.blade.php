<div class="navbar">
    <div class="navbar-container">
        ...
        <div class="header-menu">
            <ul class="nav-menu">
                <li><a class="{{ Route::is('homeAdmin') ? 'menu-link-active' : '' }}" href="{{ route('homeAdmin') }}"><i class="fa-solid fa-house"></i>Home</a></li>
                <li><a class="{{ Route::is('realisationAdmin') ? 'menu-link-active' : '' }}"  href="{{ route('realisationAdmin') }}"><i class="fa-solid fa-house"></i>Realisation</a></li>
